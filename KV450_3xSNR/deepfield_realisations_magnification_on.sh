...
# data paths
DATADIR=${HOME}/DATA/MICE2_KV450/KV450_3xSNR
MOCKmasked=${DATADIR}/MICE2_deep_uBgVrRciIcYJHKs_shapes_halos_WL_masked.fits
OUTROOT=${HOME}/DATA/MICE2_KV450/REALISATIONS_3xSNR
mkdir -p ${OUTROOT}
...
MAGsig=4.5  # scaled MAGsig to three times the original KV450 mock value
...
for survey in DEEP2 VVDSf02 zCOSMOS; do
    ...
    mocks_flux_magnification \
        ...
        --filters \
            ...
            lephare_b_evo lephare_v_evo \
            lephare_rc_evo lephare_ic_evo \
        --convergence kappa \
        -o ${OUTROOT}/temp.fits
    data_table_hstack \
        -i ${patchcat} ${OUTROOT}/temp.fits \
